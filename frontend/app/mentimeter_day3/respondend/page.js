...
// Dictionary kategori pemikiran tentang bullying
const categoryKeywords = {
  "Emosi & Perasaan": ["sedih", "takut", "cemas", "depresi", "marah", "nangis", "menangis", "murung", "trauma", "gelisah", "insecure", "minder", "stres", "stress", "tertekan"],
  "Perilaku Sosial": ["menyendiri", "sendiri", "pendiam", "diam", "menarik diri", "pemalu", "tertutup", "ansos", "anti sosial", "mengurung diri", "introvert"],
  "Fisik & Kesehatan": ["sakit", "luka", "lemas", "pusing", "makan", "tidur", "pucat", "kurus", "memar"],
  "Akademis": ["sekolah", "bolos", "nilai", "fokus", "belajar", "prestasi", "konsentrasi", "mogok"],
  "Perilaku Reaktif": ["melawan", "pelaku", "sensitif", "mudah marah", "emosian", "kasar", "memberontak", "berontak"],
};

export default function MentimeterDay3RespondentPage() {
  ...
  useEffect(() => {
    const fetchResponses = async () => {
      try {
        const res = await fetch("/api/mentimeter_day3");
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-white flex flex-col p-8 md:p-12 overflow-x-hidden font-sans">
      ...
      <div className="mb-8 text-center relative z-10">
        <h1 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-fuchsia-600 mb-4 drop-shadow-sm leading-tight">
          Menurut Bapak/Ibu, anak yang mengalami bulliying biasanya:
        </h1>
      </div>
        ...
        {loading ? (
          ...
          <div className="bg-white/80 backdrop-blur-md rounded-3xl p-8 shadow-xl border border-gray-100 flex flex-col lg:flex-row gap-8 items-center justify-center animate-fade-in-up">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center px-4">
              <h3 className="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">Analisis Tema (Karakteristik Korban Bullying)</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Grafik ini menggunakan teknik <strong>Natural Language Processing (NLP) ringan berbasis Keyword Matching</strong> untuk mengelompokkan jawaban yang maknanya saling berkaitan. Misalnya, kata kunci seperti <span className="italic">"menyendiri"</span>, <span className="italic">"pendiam"</span>, atau <span className="italic">"menarik diri"</span> otomatis digabungkan dalam satu kategori persepsi: <span className="font-semibold text-violet-600">Perilaku Sosial</span>.
              </p>
