              ...
              {isLoading ? (
                ...
                reportList.map((report) => (
                  ...
                  >
                    ...
                    <td className="px-8 py-6">
                      <span
                        className={`px-3 py-1.5 rounded-full border text-[10px] font-black uppercase tracking-wide ${
            ...
            reportList.map((report) => (
              ...
              >
                <div className="flex justify-between gap-4">
                  ...
                  <span
                    className={`h-fit px-3 py-1.5 rounded-full border text-[10px] font-black uppercase tracking-wide ${
                      statusClassName[report.status] ||
                      "bg-slate-50 text-slate-500 border-slate-100"
                    }`}
                  >
      ...
      {selectedReport && (
        <div className="fixed inset-0 z-50 -top-8 flex justify-end bg-slate-950/30 backdrop-blur-sm">
          <div className="w-full max-w-xl h-full bg-white shadow-2xl p-8 overflow-y-auto animate-in slide-in-from-right duration-300">
            ...
            <div className="mt-8">
              <span
                className={`px-4 py-2 rounded-full border text-[10px] font-black uppercase tracking-wide ${
                  statusClassName[selectedReport.status] ||
                  "bg-slate-50 text-slate-500 border-slate-100"
                }`}
              >
              ...
              {selectedReport.evidence_url && (
                <div>
                  ...
                  <img
                    ...
                    alt="Bukti laporan"
                    className="mt-3 w-full max-h-72 object-contain rounded-[24px] border border-slate-100 bg-slate-50"
                  />
                </div>
              )}
