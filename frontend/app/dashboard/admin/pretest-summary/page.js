...
export default function PreTestSummaryPage() {
  ...
  const exportExcel = () => {
    const dataToExport = preTestData.map((item, idx) => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Raw Data Pre-Test");
    XLSX.writeFile(workbook, `Data_Mentah_Pre_Test_${new Date().getTime()}.xlsx`);
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-700 pb-16 selection:bg-[#00adb5] selection:text-white print:bg-white print:pb-0">
      ...
      <nav className="relative bg-white border border-slate-100 rounded-[35px] px-4 md:px-8 py-4 flex justify-between items-center h-16 shadow-sm print-hidden mb-6">
        <div className="flex items-center gap-4">
          <Link href="/dashboard/admin" className="p-2 hover:bg-slate-100 rounded-full transition-colors text-slate-500">
            <ArrowLeft size={20} />
          </Link>
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 print:pt-4 print:px-2 print-full-width">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
           <div className="bg-white border border-slate-100 rounded-[35px] p-6 shadow-sm flex items-center gap-5 print-shadow-none hover:shadow-xl hover:shadow-slate-200/50 transition-all">
        ...
        {/* Legend Section */}
        <div className="bg-white border border-slate-100 rounded-[35px] shadow-sm overflow-hidden mb-6 print-shadow-none print:break-inside-avoid hover:shadow-xl hover:shadow-slate-200/50 transition-all">
          <div className="p-6 md:p-8 bg-slate-50 border-b border-slate-50">
        ...
        {/* Data Table Section */}
        <div className="bg-white border border-slate-100 rounded-[35px] shadow-sm overflow-hidden print-shadow-none print:mt-8 hover:shadow-xl hover:shadow-slate-200/50 transition-all">
          <div className="p-6 md:p-8 bg-slate-50 border-b border-slate-50 flex justify-between items-center print:bg-white print:border-b-2 print:border-slate-800">
            <div>
