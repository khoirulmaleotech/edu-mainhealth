...
import { 
  ...
  Settings, LogOut, Bell, Search, Menu, PieChart, ShieldCheck
} from 'lucide-react';
...
export default function SchoolAdminLayout({ children }) {
  ...
  const menuItems = [
    { name: 'Dashboard Sekolah', icon: <LayoutDashboard size={20} />, path: '/dashboard/school-admin' },
    { name: 'Guru & Wali Kelas', icon: <Users size={20} />, path: '/dashboard/school-admin/homeroom' },
    { name: 'Laporan Insiden', icon: <AlertTriangle size={20} />, path: '/dashboard/school-admin/reports' },
  ];
      ...
      `}>
        ...
        <div className="flex items-center gap-3 px-2 mb-10">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] font-bold text-[#00adb5] tracking-widest uppercase">School Admin</span>
          </div>
        </div>
        ...
        <div className="mb-4 bg-white/5 border border-white/10 rounded-2xl p-4 flex items-center gap-3">
            ...
            <div>
                ...
                <p className="text-xs font-black text-white">Sekolah Terverifikasi</p>
            </div>
        </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-black text-slate-800 leading-none">{session?.user?.name || "Bpk. Budi Santoso"}</p>
                <p className="text-[10px] font-bold text-[#00adb5] uppercase mt-1">Kepala Sekolah / BK</p>
              </div>
